    ...
    public class IncomeService : IIncomeService
    {
        ...
        private async Task<(int UserId, int AccountId)> ResolveIds(Guid userPublicId, Guid accountPublicId)
        {
            ...
            var user = await connection.QueryFirstOrDefaultAsync<dynamic>(
                "sp_GetUserByPublicId", userParams,
            ...
            var account = await connection.QueryFirstOrDefaultAsync<dynamic>(
                "sp_GetUserAccountByPublicId", accountParams,
                commandType: System.Data.CommandType.StoredProcedure);
            if (account == null)
        ...
        {
            using var connection = _db.CreateConnection();
            (int userId, int accountId) = await ResolveIds(userPublicId, request.AccountPublicId);
